...
class NavAnsattTilgangTilOppfolgingPaNavEnhetPolicyImpl(
	...
	override val name = "NavAnsattTilgangTilOppfolgingPaNavEnhet"

	override fun evaluate(input: NavAnsattTilgangTilOppfolgingPaNavEnhetPolicy.Input): Decision {
	...
	private fun harTilgangAbac(input: NavAnsattTilgangTilOppfolgingPaNavEnhetPolicy.Input): Decision {
	...
	internal fun harTilgang(input: NavAnsattTilgangTilOppfolgingPaNavEnhetPolicy.Input): Decision {
